"""
Exercise: Implement Tabu Search to Optimize a 2-Row Grid
Problem Statement
You are tasked with optimizing a 2-row grid of integers, where each row contains 9 random integers between 1 and 9. 
...
step folow : 
                1. Function to initialize the grid with 2 rows
                2. Function to generate neighbor solutions by replacing duplicates in a row
                3. Tabu Search function to find a unique row solution
                4. Apply Tabu Search to each row separately
                5. Run the algorithm for 2 rows
